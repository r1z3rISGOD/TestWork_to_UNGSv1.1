...
export function AbtNode(Nodes, i) {
 ...
 <div class="AbtNodeZone">
  ...
  <img src="./Images/${Nodes[i-1][3]}.svg" alt="" class="AbtNodeZone_img">
  ${Nodes[i-1][1]}</h1>
  <h3 class="AbtNodeZone_status">Статус<img class="AbtNodeZone_status_active" src="./Images/${Nodes[i-1][0]}.svg" alt=""></h3>
