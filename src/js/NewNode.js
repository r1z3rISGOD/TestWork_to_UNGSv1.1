...
export function NewNode() {
    Data.innerHTML = `<form id="5" class="NewNode">
    ...
    <h3 class="NewNode_address">Адрес узла<input placeholder="123.123.123.123" pattern='^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$' class="NewNode_address_input NewNode_address_input-adres" type="text" required></h3>
    </div>
    <div class="NewNode_btn">
    <input form="5" type="submit" class="NewNode_add" value="Добавить"></input>
 ...
 NewNodeAdd.addEventListener('click', function(){
     ...
     if (NewNodeAddress.checkValidity() == true) {
         for(let i=0; i<Nodes.length; i++) {
             ...
             console.log(`${NewNodeAddress.value} ${Nodes[i][4]}`);
